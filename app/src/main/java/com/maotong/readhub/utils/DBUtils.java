...
public class DBUtils {
    ...
    public class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL(String.format(CREATE_TABLE_IF_NOT_EXISTS, Config.READHUB));
            db.execSQL(String.format(CREATE_TABLE_IF_NOT_EXISTS, Config.READHUB_NEWS));
            db.execSQL(String.format(CREATE_TABLE_IF_NOT_EXISTS, Config.READHUB_TECH));
        }
