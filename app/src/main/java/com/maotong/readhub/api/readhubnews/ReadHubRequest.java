...
public class ReadHubRequest {
    ...
    private static com.maotong.readhub.api.readhubnews.ReadHubApi ReadHubApi = null;

    public static com.maotong.readhub.api.readhubnews.ReadHubApi getReadHubApi() {
