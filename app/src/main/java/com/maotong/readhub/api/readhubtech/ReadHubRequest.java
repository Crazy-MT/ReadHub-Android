...
public class ReadHubRequest {
    ...
    private static com.maotong.readhub.api.readhubtech.ReadHubApi ReadHubApi = null;

    public static com.maotong.readhub.api.readhubtech.ReadHubApi getReadHubApi() {
        synchronized (monitor) {
            if (ReadHubApi == null) {
                ReadHubApi = new Retrofit.Builder()
                        ...
                        .build().create(com.maotong.readhub.api.readhubtech.ReadHubApi.class);
            }
            return ReadHubApi;
        }
    }
