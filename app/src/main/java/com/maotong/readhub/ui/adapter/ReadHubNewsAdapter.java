...
public class ReadHubNewsAdapter extends RecyclerView.Adapter<ReadHubNewsAdapter.ReadHubViewHolder> {
    ...
    public ReadHubNewsAdapter(ArrayList<Datum> readHubNewsItems, Context context) {
